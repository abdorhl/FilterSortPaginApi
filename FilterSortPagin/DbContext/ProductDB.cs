using FilterSortPagin.Models;
using System.Xml.Linq;

namespace FilterSortPagin.DbContext
{
        ...
        public List<ProductModel> ProductDataContext { get; } = new List<ProductModel>()
            {
                    ...
                    new ProductModel() { Id = 18, Name = "Land phone", Description = "Land phone", Price = 290 },
                    new ProductModel() { Id = 19, Name = "Mobile phone", Description = "5G Mobile phone", Price = 4500 },
                    new ProductModel() { Id = 20, Name = "Mac Book", Description = "Mac Book", Price = 2000 },
                    new ProductModel() { Id = 21, Name = "Surface", Description = "MS Surface Pro", Price = 3400 },
                    new ProductModel() { Id = 22, Name = "UPS", Description = "UPS", Price = 200 },
                    new ProductModel() { Id = 23, Name = "Pen Stand", Description = "Pen Stand", Price = 10 },
            };
    }
